...
@customElement('date-copy')
export class DateCopy extends LitElement {
    ...
    render() {
      ...
      <vaadin-date-picker theme="small"
        label="Kopiuj stan z dnia:"
        value="${feedViewStore.copyDate}"
    ...
    dateChanged( e: CustomEvent ) {
        feedViewStore.dateCopyChanged(e.detail.value as string);
    }
}
